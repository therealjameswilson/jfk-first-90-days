  ...
  const data = {
    metadata: {
      ...
      officialSources: [
        ...
        {
          label: 'JCS Joint Staff History',
          url: 'https://www.jcs.mil/About/Joint-Staff-History/',
        },
        {
          label: 'JCS and National Policy, Vol. VIII, 1961-1964 PDF',
          url: 'https://www.jcs.mil/Portals/36/Documents/History/Policy/Policy_V008.pdf',
        },
        {
